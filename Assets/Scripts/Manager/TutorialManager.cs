...
public class TutorialManager : MonoBehaviour
{
    public TutorialStep[] testTutorials = {
                                        new TutorialStep(230, 370, "Tutorial 1 / 7", "Next", 500, 350, 90, "This is your farm, it gives you 2GP per year as long as it's safe from the pest. If the pest reaches you, you lose the game."),
    ...
    public TutorialStep[] studyTutorial = {
        new TutorialStep(240, 240, "Tutorial 1/1", "Start Game", "You will now be connected to four other players and play the study game.")
    };
